...
datevecend1=[2023 07 20]; % time stamp of the most recent data file in format [year_number month_number day_number]. This data file is accessed to assess forecast performance
...
if npatches_fixed==1  % if one sub-epidemic is employed, then there is only one model (One sub-epidemic model)
    topmodelsx=1;
end
